...
+ (void)initWithStoryboard:(NSString * _Nonnull)storyboardName
                  ...
                  logoIcon:(UIImageView *_Nonnull) logoIcon { /// add argument
  ...
  //// add \/
  UIView *catView = [[UIView alloc] initWithFrame:CGRectMake(_splashVC.view.frame.size.width/2-50,
                                                              _splashVC.view.frame.size.height/2-50,
                                                              100,
                                                              100)];
  logoIcon.frame = catView.bounds;
  [catView addSubview:logoIcon];

  catView.transform = CGAffineTransformMakeScale(0.1, 0.1);

  [_splashVC.view addSubview:catView];
  ///  /\ 
  ...
  catView.transform = CGAffineTransformMakeScale(1.0f, 1.0f);
