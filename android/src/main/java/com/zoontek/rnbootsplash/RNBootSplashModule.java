...
public class RNBootSplashModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
  ...
  private static int mAnimResId = -1;
  private static int mBgrResId = -1;
  ...
  private static LinearLayout getLayout(@NonNull Activity activity, LayoutParams params) {
    ...
    Animation animation = AnimationUtils.loadAnimation(mContext, mAnimResId);////
    layout.setBackgroundResource(mBgrResId);////
  ...
  protected static void init(final @DrawableRes int drawableResId, 
